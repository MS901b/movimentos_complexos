	var codigo_do_software = "movimentoscomplexos";
	var nome_do_software = "Movimentos complexos";
	var tipo = "software";
	...
	var FichaTecnica = $H({
		...
		sinopse: {
			titulo: 'Sinopse',
			conteudo: 'Neste software, utilizando o conceito e propriedades de números complexos, são estudadas as transformações de translação, rotação, dilatação e contração no plano complexo. O estudo é realizado por meio da análise do efeito dessas transformações em triângulos e, em especial, são utilizadas as interpretações geométricas das operações de números complexos.'
		},
		conteudos: {
			titulo: 'Conteúdo',
			conteudo: 'Transformações: translação, rotação, dilatação e contração; Números complexos: operações e propriedades;'
		},
		objetivos: {
			titulo: 'Objetivos',
			conteudo: 'Estudar o efeito da translação, rotação, dilatação e contração no plano complexo; Aplicar os conceitos e propriedades de número complexo; Utilizar as propriedades geométricas das operações de números complexos.'
		},
		duracao: {
			titulo: 'Duração',
...
/*,
	...
	var site_projeto = 'http://m3.mat.br/';
